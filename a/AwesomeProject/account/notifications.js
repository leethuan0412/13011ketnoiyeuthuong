...
const UselessTextInput = () => {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: '#E5E5E5', height: '100%', }}>
            <View style={{flexDirection:'row',justifyContent: 'space-between',borderBottomWidth:1,padding:16}}>
                <Image source={image} resizeMode="contain" style={styles.image} />
                <Text style={{fontSize:20,}}>Tin nhắn</Text>
                <Switch
            ...
            <View style={{flexDirection:'row',justifyContent: 'space-between',borderBottomWidth:1,padding:16,}}>
                ...
                <Text style={{fontSize:20,}}>Người theo dõi</Text>
                <Switch
                    trackColor={{ false: "#767577", true: "green" }}
